...
// in chinese_food_app/test/unit/domain/usecases/wide_area_search_usecase_test.dart.
...
class MockStoreRepository extends _i1.Mock implements _i2.StoreRepository {
  ...
  @override
  _i3.Future<void> deleteAllStores() => (super.noSuchMethod(
        Invocation.method(
          #deleteAllStores,
          [],
        ),
  ...
  @override
  _i3.Future<List<_i4.Store>> searchStoresFromApi({
    double? lat,
    double? lng,
    String? address,
    String? keyword,
